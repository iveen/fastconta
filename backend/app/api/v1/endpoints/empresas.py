...
async def _validar_nit(
    ...
    schema_name: str,
    nit: str,
    empresa_id_excluir: str | None = None
) -> None:
    """
...
async def get_mis_empresas(
    ...
    Versión simplificada para evitar timeouts y errores de lazy loading.
    """
    try:
...
# ============================================================
# 2. Crear empresa (CON VALIDACIÓN DE NIT)
# ============================================================
...
async def create_empresa(
    ...
    # 2. ✅ VALIDAR NIT (formato + unicidad)
