...
from app.schemas.sat.regla_filtrado import (
...
from app.services.sat.regla_filtrado_service import ReglaFiltradoService
...
async def listar_reglas(
    casilla_id: int | None = Query(None, description="Filtrar por casilla"),  # ✅ BIGINT
