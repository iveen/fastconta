...
class UserCreate(BaseModel):
    ...
    role: str = Field(
        ..., pattern="^(superadmin|tenant_manager|tenant_member|tenant_client)$", description="Rol del usuario"
    )
    tenant_id: int | None = Field(None, description="ID del tenant (requerido solo para superadmin)")
