...
class CasillaSatBase(BaseModel):
    ...
    dependencias: list[str] | None = Field(
        None, description="Lista de códigos de casillas de las que depende para cálculo", examples=[["3.1", "3.2"]]
    )
    ...
    parametros_funcion: dict | None = Field(
        ...
        examples=[{"tramos": [{"hasta": 30000, "tasa": 0.05}, {"hasta": None, "tasa": 0.07}], "referencia": "3.3"}],
    )
