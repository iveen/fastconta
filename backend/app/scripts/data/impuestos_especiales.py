...
IMPUESTOS_ESPECIALES = [
    {"codigo": "PETROLEO", "nombre": "Petróleo", "descripcion": "Impuesto al Petróleo (Decreto 72-96)."},
    {
    ...
    {"codigo": "CEMENTO", "nombre": "Cemento", "descripcion": "Impuesto Específico al Cemento (Decreto 56-2013)."},
    {
