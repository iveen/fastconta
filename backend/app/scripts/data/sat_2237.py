...
NOTA: Las reglas de filtrado usan SOLO campos que existen en FacturaElectronica:
  - tipo_operacion, es_exportacion, es_importacion
  - clasificacion_gasto_sat, tipo_documento
  - pais_destino_exportacion, retencion_iva
  - total_exento_gtq, total_gravado_gtq, total_gravado_bienes_gtq,
    total_gravado_servicios_gtq, total_iva_gtq, total_gtq
  - es_medicamento, es_vehiculo, es_vehiculo_usado, es_vehiculo_nuevo
  - es_pequeno_contribuyente, es_no_afecta, no_genera_credito_fiscal
  - tiene_constancia_exencion, es_exento
  - region_destino (LOCAL|CENTROAMERICA|RESTO_MUNDO)
  - bien_o_servicio_predominante (B|S|M)

La sección 6 (Crédito Fiscal Exportaciones) queda como casillas editables
manualmente, porque "es_para_exportacion" es criterio contable del usuario
(no se puede determinar automáticamente del XML de una compra).
"""
...
CASILLAS_SAT_2237 = [
    ...
    # ⚠️  Las casillas base (6.1-6.7) quedan como editables manualmente.
    # Las casillas _C y sumatorias se calculan automáticamente por fórmula.
    # =========================================================================
...
#
# ⚠️  IMPORTANTE: Solo se usan campos que existen en FacturaElectronica.
# Los campos denormalizados del clasificador (es_medicamento, es_vehiculo,
# es_exento, region_destino, bien_o_servicio_predominante, etc.) se calculan
# al momento de la ingestión FEL.
# =========================================================================
REGLAS_FILTRADO_SAT_2237 = [
    ...
    # =========================================================================
    {
        ...
        "campo_factura": "total_exento_gtq",
        "operacion": "SUMA",
        "orden": 1,
    },
    {
        "casilla_codigo": "3.2",
        "nombre": "Ventas de medicamentos genéricos, alternativos y antirretrovirales",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exento": False,
            "es_exportacion": False,
        ...
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
        "orden": 2,
    },
    {
        "casilla_codigo": "3.3",
        "nombre": "Ventas no afectas realizadas a contribuyentes calificados Decreto 29-89",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_no_afecta": True,
        },
        "campo_factura": "total_gtq",
        "operacion": "SUMA",
        "orden": 3,
    },
    {
        "casilla_codigo": "3.4",
        "nombre": "Ventas de vehículos terrestres (2+ años anteriores)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_vehiculo_usado": True,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
        "orden": 4,
    ...
    {
        "casilla_codigo": "3.5",
        "nombre": "Ventas de vehículos terrestres (año en curso, siguiente o anterior)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_vehiculo_nuevo": True,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
        "orden": 5,
    ...
    {
        "casilla_codigo": "3.6",
        "nombre": "Ventas de Bienes Gravados",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exento": False,
            "es_exportacion": False,
            "bien_o_servicio_predominante": "B",
        },
        "campo_factura": "total_gravado_bienes_gtq",
        "operacion": "SUMA",
        "orden": 6,
    },
    {
        ...
        "criterios_json": {
            ...
            "es_exento": False,
            "es_exportacion": False,
            "bien_o_servicio_predominante": "S",
        },
        "campo_factura": "total_gravado_servicios_gtq",
        "operacion": "SUMA",
        "orden": 7,
    },
    ...
    {
        "casilla_codigo": "4.1",
        "nombre": "Exportaciones a Centroamérica (excepto Honduras)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exportacion": True,
            "region_destino": "CENTROAMERICA",
            "pais_destino_exportacion": {"$ne": "Honduras"},
        },
        "campo_factura": "total_gtq",
        "operacion": "SUMA",
        "orden": 1,
    ...
    {
        "casilla_codigo": "4.2",
        "nombre": "Exportaciones al resto del mundo",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exportacion": True,
            "region_destino": "RESTO_MUNDO",
        },
        "campo_factura": "total_gtq",
        "operacion": "SUMA",
        "orden": 2,
    ...
    {
        "casilla_codigo": "4.3",
        "nombre": "Transferencias FYDUCA",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "tipo_documento": "FYDUCA",
        },
        "campo_factura": "total_gtq",
        "operacion": "SUMA",
        "orden": 3,
    ...
    {
        "casilla_codigo": "4.4",
        "nombre": "Ventas de medicamentos genéricos (Exportación)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exportacion": True,
            "es_medicamento": True,
    ...
    {
        "casilla_codigo": "4.5",
        "nombre": "Ventas de vehículos terrestres (2+ años anteriores) (Exportación)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exportacion": True,
            "es_vehiculo_usado": True,
    ...
    {
        "casilla_codigo": "4.6",
        "nombre": "Ventas de vehículos terrestres (recientes) (Exportación)",
        "criterios_json": {
            "tipo_operacion": "Venta",
            "es_exportacion": True,
            "es_vehiculo_nuevo": True,
    ...
    {
        "casilla_codigo": "5.1",
        "nombre": "Compras de medicamentos genéricos, alternativos y antirretrovirales",
        "criterios_json": {
    ...
    {
        "casilla_codigo": "5.2",
        "nombre": "Compras y servicios adquiridos de pequeños contribuyentes",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "es_pequeno_contribuyente": True,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
        "orden": 2,
    ...
    {
        "casilla_codigo": "5.3",
        "nombre": "Compras que no generan derecho a compensación del crédito fiscal",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "no_genera_credito_fiscal": True,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
        "orden": 3,
    ...
    {
        "casilla_codigo": "5.4",
        "nombre": "Compras de vehículos terrestres (2+ años anteriores)",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "es_vehiculo_usado": True,
            "es_importacion": False,
    ...
    {
        "casilla_codigo": "5.5",
        "nombre": "Compras de vehículos terrestres (año en curso, siguiente o anterior)",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "es_vehiculo_nuevo": True,
            "es_importacion": False,
    ...
    {
        "casilla_codigo": "5.6",
        "nombre": "Compras de Combustibles",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "clasificacion_gasto_sat": "COMBUSTIBLE",
            "es_importacion": False,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
    ...
    {
        "casilla_codigo": "5.7",
        "nombre": "Otras Compras (Bienes)",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "clasificacion_gasto_sat": "NORMAL",
            "bien_o_servicio_predominante": "B",
            "es_importacion": False,
        },
        "campo_factura": "total_gravado_bienes_gtq",
    ...
    {
        "casilla_codigo": "5.9",
        "nombre": "Importaciones de Centro América",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "es_importacion": True,
            "region_destino": "CENTROAMERICA",
    ...
    {
        "casilla_codigo": "5.10",
        "nombre": "Adquisiciones con FYDUCA",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "tipo_documento": "FYDUCA",
        },
    ...
    {
        "casilla_codigo": "5.11",
        "nombre": "Importaciones del resto del mundo",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "es_importacion": True,
            "region_destino": "RESTO_MUNDO",
    ...
    {
        "casilla_codigo": "5.12",
        "nombre": "Compras de Activos Fijos",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "clasificacion_gasto_sat": "ACTIVO_FIJO",
            "es_importacion": False,
        },
        "campo_factura": "total_gravado_gtq",
        "operacion": "SUMA",
    ...
    {
        "casilla_codigo": "5.13",
        "nombre": "Importación de activos fijos",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "clasificacion_gasto_sat": "ACTIVO_FIJO",
            "es_importacion": True,
    ...
    {
        "casilla_codigo": "5.14",
        "nombre": "IVA conforme constancias de exención recibidas",
        "criterios_json": {
            "tipo_operacion": "Compra",
            "tiene_constancia_exencion": True,
        },
        "campo_factura": "total_iva_gtq",
        "operacion": "SUMA",
        "orden": 14,
    },
    ...
    # =========================================================================
    # SECCIÓN 6: CRÉDITO FISCAL EXPORTACIONES
    # ⚠️  NO hay reglas automáticas. Las casillas 6.1-6.7 son editables
    # manualmente porque "es_para_exportacion" es criterio contable del
    # usuario (no se puede determinar del XML de una compra local).
    # Las casillas _C y sumatorias se calculan automáticamente por fórmula.
    # =========================================================================
    # (Intencionalmente vacío - el usuario completa manualmente)

    # =========================================================================
    # SECCIÓN 9.1: CONTEOS DE DOCUMENTOS
    # ⚠️  Los conteos requieren lógica especial (COUNT en lugar de SUMA).
    # Se pueden agregar reglas con operacion="CONTEO" si el motor lo soporta.
    # Por ahora, el usuario completa manualmente o se hace en un paso posterior.
    # =========================================================================
]
