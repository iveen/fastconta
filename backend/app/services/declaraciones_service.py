...
MAPA_CALCULO_SAT_2237 = {
    ...
    "REMANENTE_CREDITO_EXPORTACIONES": {
        "tipo": "CREDITO",
        "seccion": "6",
        "filtro": lambda f: False,  # Se calcula manualmente
        "campo_base": None,
        "campo_impuesto": None,
    },
...
async def generar_formulario_sombra(
    ...
    for casilla in casillas:
        ...
        if regla:
            # Usar todas_las_facturas para indicadores
            ...
            if regla["tipo"] == "DEBITO":
                ...
                total_exportaciones += base_calc  # Solo base, no impuesto
                total_base_debitos += base_calc  # Las exportaciones suman a la base total
    ...
    # Guardar casillas de Sección 8
    casillas_seccion8 = {
        "INDICADORES_COMERCIALES": redondear_entero(indicadores_comerciales),
        "RAZON_VENTAS_COMPRAS": int(razon_ventas_compras * 100),  # Porcentaje
    }
