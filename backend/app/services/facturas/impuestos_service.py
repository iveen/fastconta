...
def guardar_impuestos_especiales_factura(db: Session, factura: FacturaElectronica, impuestos_detectados: dict) -> None:
    """
    ...
    for codigo_bd, monto in impuestos_detectados.items():
        ...
        if catalogo:
            ...
            impuesto_registro = FacturaImpuestoEspecial(factura_id=factura.id, catalogo_id=catalogo.id, monto=monto)
