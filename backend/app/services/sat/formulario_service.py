...
class FormularioSatService:
    ...
    async def obtener_por_id(self, formulario_id: int) -> FormularioSat | None:  # ✅ int (era UUID)
    ...
    async def actualizar(
        self,
        formulario_id: int,  # ✅ int (era UUID)
        data: dict,
    ...
    async def eliminar(self, formulario_id: int) -> bool:  # ✅ int (era UUID)
    ...
    async def duplicar_version(
        ...
        mapa_secciones: dict[int, SeccionFormulario] = {}  # ✅ int (era UUID)
        ...
        # Duplicar casillas
        mapa_casillas: dict[int, CasillaSat] = {}  # ✅ int (era UUID)
        for seccion_orig in original.secciones:
